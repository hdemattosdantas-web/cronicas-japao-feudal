...
CREATE TABLE "Attributes" (
    ...
    "socialPerception" INTEGER NOT NULL DEFAULT 5,
    "spiritualPerception" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Character_parentCharacterId_idx" ON "Character"("parentCharacterId");
...
-- CreateIndex
CREATE INDEX "ChatRoom_campaignId_idx" ON "ChatRoom"("campaignId");
