...
exports.personalityManager = exports.GameMasterPersonalityManager = exports.GAME_MASTER_PERSONALITIES = exports.GameMasterMood = void 0;
var GameMasterMood;
(function (GameMasterMood) {
    GameMasterMood["SERENE"] = "serene";
    GameMasterMood["PLAYFUL"] = "playful";
    GameMasterMood["HARSH"] = "harsh";
    GameMasterMood["MYSTERIOUS"] = "mysterious";
    GameMasterMood["FATEFUL"] = "fateful";
    GameMasterMood["CHAOTIC"] = "chaotic"; // Imprevisível, caótico
})(GameMasterMood || (exports.GameMasterMood = GameMasterMood = {}));
exports.GAME_MASTER_PERSONALITIES = {
...
class GameMasterPersonalityManager {
    constructor() {
        // Começa com uma personalidade aleatória
        const personalities = Object.values(exports.GAME_MASTER_PERSONALITIES);
    ...
    changePersonality(personalityId) {
        if (exports.GAME_MASTER_PERSONALITIES[personalityId]) {
            this.currentPersonality = exports.GAME_MASTER_PERSONALITIES[personalityId];
        }
    }
    ...
    adaptPersonality(gameContext) {
        ...
        if (supernaturalEvents > 10 && playerLevel > 8) {
            ...
            const personalities = Object.keys(exports.GAME_MASTER_PERSONALITIES);
...
exports.GameMasterPersonalityManager = GameMasterPersonalityManager;
exports.personalityManager = new GameMasterPersonalityManager();
